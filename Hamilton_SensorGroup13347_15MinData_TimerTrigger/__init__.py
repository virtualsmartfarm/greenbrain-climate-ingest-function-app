...
def main(mytimer: func.TimerRequest) -> None:
    ...
    response_13347_str = json.loads(response.text)
    # print(response_13347_str)
    # Minimum temperature sensor reading from 'sensor groups' 13347
    response_90893_min_df = pd.json_normalize(response_13347_str['sensorTypes']['airTemperature']['sensors']['minimum']['readings'])
    ...
    response_90894_avg_df = pd.json_normalize(response_13347_str['sensorTypes']['airTemperature']['sensors']['average']['readings'])
    ...
    response_90895_max_df = pd.json_normalize(response_13347_str['sensorTypes']['airTemperature']['sensors']['maximum']['readings'])
    payload_df(response_90895_max_df, 'degree_celsius', '90895airtempmax')
    # Rainfall sensor reading from 'sensor groups' 13347
    response_90906_rainfall_df = pd.json_normalize(response_13347_str['sensorTypes']['rainfall']['sensors']['rainfall']['readings'])
