...
def main(mytimer: func.TimerRequest) -> None:
    ...
    payload_df(response_90893_min_df, 'celsius', 'airtempmin90893')
    ...
    # Query Cosmos Db to create a CSV of all records
    sensor_query('airtempmin90893', 'hamilton_smartfarm', 'celsius')
    sensor_query('airtempavg90894', 'hamilton_smartfarm', 'celsius')
    sensor_query('airtempmax90895', 'hamilton_smartfarm', 'celsius')
    sensor_query('rainfall90906', 'hamilton_smartfarm', 'mm')
    if mytimer.past_due:
