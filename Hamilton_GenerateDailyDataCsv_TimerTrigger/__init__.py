...
def main(mytimer: func.TimerRequest) -> None:
    ...
    generate_daily_csv('airtempmin90893', 'hamilton_smartfarm')
    generate_daily_csv('airtempavg90894', 'hamilton_smartfarm')
    generate_daily_csv('airtempmax90895', 'hamilton_smartfarm')
    generate_daily_csv('90906rainfall', 'hamilton_smartfarm')