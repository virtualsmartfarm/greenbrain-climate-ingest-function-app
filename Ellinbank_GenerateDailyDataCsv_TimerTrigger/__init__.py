...
def main(mytimer: func.TimerRequest) -> None:
    ...
    generate_daily_csv('airtempmin46977', 'ellinbank_smartfarm')
    generate_daily_csv('airtempavg46978', 'ellinbank_smartfarm')
    generate_daily_csv('airtempmax46979', 'ellinbank_smartfarm')
    generate_daily_csv('rainfall46991', 'ellinbank_smartfarm')
